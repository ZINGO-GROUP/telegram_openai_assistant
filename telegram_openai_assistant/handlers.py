...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await context.bot.send_message(
        chat_id=update.effective_chat.id, text="Assalomu aleykum! Men zingo ning suniy intellekti bo'laman. Zingo haqida barcha savollarga javob bera olishim mumkin"
    )
